...
@section('title', 'Pemetaan Gereja United')
...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold">📍 Pemetaan Jaringan United</h2>
        <span class="badge bg-primary">{{ $churches->count() }} Gereja Terdaftar</span>
    </div>
...
<script>
    // Inisialisasi Peta (Default Palembang)
    const map = L.map('map').setView([-2.9333, 104.7833], 13);
